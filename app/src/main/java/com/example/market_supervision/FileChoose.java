...
public class FileChoose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.getSettings().setBuiltInZoomControls(false);
        String url="http://"+ CommonConstant.srvIp +":12345/market/synQuery/fileManage?userId="+ SPUtils.get(getApplicationContext(),"userId","1");
        webView.loadUrl(url);
//        setContentView(webView);                           //调用Activity提供的setContentView将webView显示出来
        findViewById(R.id.back_log_back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(FileChoose.this, HomeActivity.class);
                startActivity(intent);
            }
        });
...
//                take();
    ...
    private void onActivityResultAboveL(int requestCode, int resultCode, Intent data) {
        ...
        if(results!=null){
            ...
            try {
                input = getApplicationContext().getContentResolver().openInputStream(imageUri);
...
//        i.setType("image/*");
        ...
        FileChoose.this.startActivityForResult(chooserIntent,  FILECHOOSER_RESULTCODE);
    }
//    @Override
//    public boolean onKeyDown(int keyCode, KeyEvent event) {
//        if (keyCode == KeyEvent.KEYCODE_BACK && webView.canGoBack()) {
